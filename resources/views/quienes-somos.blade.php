...
<!--HEADER SECTION-->
<section class="inner-page-banner" style="background-image:url(img/banner/qs-banner.png)">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-6">
                <div class="team wow fadeIn">
                    <div class="thumb text-center">
                        <img src="img/team/2.png" alt="" style="width:150px;">
                    </div>
                    <div class="team-info text-center">
                        <h3>Lic. Andrea Gago Carballo</h3>
            ...
            <div class="col-sm-6 col-md-6">
                <div class="team wow fadeIn">
                    <div class="thumb text-center">
                        <img src="img/team/1.png" alt="" style="width:150px;">
                    </div>
                    <div class="team-info text-center">
                        <h3>Jorge Zunino</h3>
                        <h6>CEO Spain & Latam</h6>
                    </div>
                    <div class="team-overlay text-center">
                        <h3>Jorge Zunino</h3>
                        <h6>CEO Spain & Latam</h6>
